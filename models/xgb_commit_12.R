...
load("./data_V12/trainD.RData")
load("./data_V12/testD.RData")
labels <- read_csv("./data_V12/labels.csv")
testId <- read_csv("./data_V12/test_user_ids.csv")
target <- labels$country_destination
tid <- read_csv("./data_V12/tid.csv")
...
write_csv(sub, "./Submissions/xgb_commit_13.csv")
write_csv(pmat, "./Raw Predictions/xgb_commit_13_raw.csv")
